<%@ Page Title="Products Page | Fleur.com.bn." Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="_1525586_CO5027_ASG.product" %>
            ...
            <ItemTemplate>
                <div class="rptrProduct">
                    <a href="<%# Eval ("Id", "ViewProduct.aspx?Id={0}") %>">
                        <div>
                            <asp:Image ID="displayProductImage" runat="server" Height="200px" ImageUrl='<%# Eval("product_images") %>' Width="200px" AlternateText='<%# Eval("product_desc") %>' />
                        </div>
